...
#%%
import os,sys
code_dir = f"/home/dma73/Code/medical_image_analysis/cohorts/BrainMRI/T1_Hypo_T2_Hyper/torchio_pipeline"
sys.path.insert(1,code_dir)
from utils import plot_histogram, prepare_batch, get_model_and_optimizer, train, plot_times
#%%
random.seed(seed)
